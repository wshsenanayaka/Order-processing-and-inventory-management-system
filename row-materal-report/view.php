...
<?php 
    ...
    $queryView= "SELECT * FROM  row_materal_report WHERE id ='$id'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Row Materal Report View</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <?php
                    ...
                    $queryView= "SELECT * FROM  row_material WHERE createDate BETWEEN '$startDate' AND '$endDate'";
                    $resultView = mysqli_query($conn ,$queryView);
