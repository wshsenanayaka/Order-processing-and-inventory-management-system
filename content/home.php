                    ...
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        ...
                        <?php
                            ...
                            $querypi= "SELECT item_id FROM  customer_order_item  GROUP BY item_id ORDER BY COUNT(item_id) DESC 
                            LIMIT 1";
                          ...
                          ?>
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $item_id; ?></div>
                        </div>
                        <div class="col">
